...
For this assignment I will be using [Joey's Singer Dataset](https://github.com/JoeyBernhardt/singer), and gapminder occasionally.
...
```{r}
ggsave("images/violin_plot.png", plot = violin_plots, width = 9) # plot matters since it would otherwise store the latest run plot!
```

And loading this same image back:
![Done assignment]("images/violin_plot.png")
